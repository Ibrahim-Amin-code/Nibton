    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
          ...
          child: Container(
            ...
            padding:  EdgeInsets.only(top: 4.h,left: 5.w,bottom: 3.h,right: 3.w),
            decoration: BoxDecoration(
                gradient: LinearGradient(
                    colors: [HexColor('#40A2A6'),HexColor('#4CB8BA')])),
            child: Row(
              children: [
                Image.asset('assets/images/categories.png',color: Colors.white,),
                SizedBox(width: 10,),
                Text(LocaleKeys.Categories.tr(),style: TextStyle(
                    fontFamily: 'OpenSans',
                    color: Colors.white,
                    fontSize: 20,
