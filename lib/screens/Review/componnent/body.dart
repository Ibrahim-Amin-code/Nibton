          ...
          children: [
            ...
            ListView.separated(
                ...
                itemBuilder: (context, index) => reviewContent(
                  name: HomeCubit.get(context).classReviewsModel.data![index].buyer!.name.toString(),
                  comment: HomeCubit.get(context).classReviewsModel.data![index].comment.toString(),
                  date: HomeCubit.get(context).classReviewsModel.data![index].date.toString(),
                  rate: HomeCubit.get(context).classReviewsModel.data![index].rate.toString(),
                ),
                separatorBuilder: (context, index) => spaceH(10),
                itemCount: HomeCubit.get(context).classReviewsModel.data!.length),
            spaceH(30),
            SizedBox(
              ...
              child: DefaultButton(
                  ...
                  press: () => Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => WriteReviewScreen(iD: widget.id,)))),
            )
          ],
        );
      },
