...
import 'package:nibton_app/screens/menu_screens/language/language_screen.dart';
import 'package:nibton_app/screens/menu_screens/privacy_policy/privacy_screen.dart';
import 'package:nibton_app/screens/menu_screens/profile/edit_profile_screen.dart';
import 'package:nibton_app/screens/menu_screens/resetPassword/resetPass.dart';
import 'package:nibton_app/screens/menu_screens/terms_and_condition/terms_and_condition_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
          ...
          child: Container(
            padding:  EdgeInsets.only(top: 4.h,left: 5.w,bottom: 3.h,right: 5.w),
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 2.w,),
                Text(LocaleKeys.Menu.tr(),style: TextStyle(
                    fontFamily: 'OpenSans',
                    color: Colors.white,
                    fontSize: 17.sp,
